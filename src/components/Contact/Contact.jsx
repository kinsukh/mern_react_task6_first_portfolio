  ...
  return (
    <section className="contact container section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">kinsukh2003@gmail.com</span>
              <a
                href="mailto:kinsukh2003@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">9689626982</span>
              <a
        ...
        <div className="contact__content">
          <h3 className="conatct__title">Whrite me your Project</h3>
